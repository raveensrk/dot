...
(add-to-list 'load-path "~/dot/config/emacs/packages")
...
;; org-auto-align-tags on, so a one-word title edit re-pads the whole line.
;; The two archive settings keep an absolute path out of every archive file:
;; org writes /Users/<name>/... into both the header and the drawer otherwise.
(progn
  (setq
   org-M-RET-may-split-line nil
   org-agenda-files nil ; populated by org_agenda.el before each agenda build
