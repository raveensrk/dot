...
setlocal formatprg=verible-verilog-format\ --indentation_spaces\ 4\ --over_column_limit_penalty\ 200\ -
function! s:Format(line1,line2) abort
	let save_cursor = getcurpos()
	execute a:line1 . ',' . a:line2 . "!verible-verilog-format --indentation_spaces 4 --over_column_limit_penalty 200 -"
